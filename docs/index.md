...
**dhybridrpy** is a Python package that allows you to easily load and plot data from [dHybridR](https://github.com/dHybridR/dHybridR) simulations. It provides programmatic access to simulation input and output data with the ability to quickly visualize that data.
...
- Report issues on [GitHub](https://github.com/bwostler/dhybridrpy/issues)

## License

This project is licensed under the GNU Affero General Public License v3.0. See the [LICENSE](https://github.com/bwostler/dhybridrpy/blob/main/LICENSE) file for details.
